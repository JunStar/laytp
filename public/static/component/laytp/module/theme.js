layui.define(["jquery","layer"], function (exports) {
	...
	theme.colorSet = function(color) {
		...
		style += '.laytp-admin .pe-collaspe {background-color:' + color + '!important}';
		style += '.layui-fixbar li {background-color:' + color + '!important}';
		if(this.autoHead){
			style += '.laytp-admin .layui-header{background-color:' + color + '!important;}.laytp-admin .layui-header .layui-nav .layui-nav-item>a{color:white!important;}';
		}
		...
		style += '.layui-form-radio:hover *, .layui-form-radioed, .layui-form-radioed>i {color: ' + color + ';}'
		...
		style += '.laytp-text{color:' + color + '!important}';
		style += '.laytp-collasped-pe{background-color:'+color+'!important}'
