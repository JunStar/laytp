layui.define(['table', 'jquery', 'element'], function(exports) {
	...
	function getData(url) {
		...
		var data = null;
		$.ajax({
			url: localStorage.getItem("staticDomain") + url,
			type:"GET",
			dataType:"JSONP",
		...
		// $.get(localStorage.getItem("staticDomain") + url, function(result) {
		// 	data = result;
		// });
	...
	function createHtml(option) {
        ...
        var notice = '<li class="layui-nav-item" lay-unselect="">' +
			'<a href="javascript:void(0);" class="notice layui-icon layui-icon-notice"><span class="layui-badge-dot"></span></a>' +
			'<div class="layui-nav-child layui-tab laytp-notice" style="margin-top: 0px;;left: -200px;">';
