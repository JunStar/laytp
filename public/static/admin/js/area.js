layui.use(["laytp"], function () {
    const funController = {};
    //静态页面地址前缀
    window.htmlPrefix = facade.compatibleHtmlPath("/admin/area/");
    //后端接口地址前缀
    window.apiPrefix  = facade.compatibleApiRoute("/admin.area/");
    ...
    funController.tableRender = function (where) {
        ...
        laytpTreeTable = layui.treeTable.render({
            ...
            , url: facade.url("/admin.area/index", {is_tree:1})
            , where: where
            , method: "GET"
            ...
            , cols: [[
				...
				,{field:'sort',title:'排序',align:'center',templet:function(d){
                        return laytpForm.tableForm.editInput('sort',d,'/admin.area/setSort');
                    }}
