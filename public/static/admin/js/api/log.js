layui.use(["laytp"], function () {
    const funController = {};
    //静态页面地址前缀
    window.htmlPrefix = facade.compatibleHtmlPath("/admin/api/log/");
    //后端接口地址前缀
    window.apiPrefix  = facade.compatibleApiRoute("/admin.api.log/");
    ...
    funController.tableRender = function (where, page) {
        layui.table.render({
            elem: "#laytp-table"
            , id: "laytp-table"
            , url: facade.url("/admin.api.log/index")
            ...
            , cols: [[
				...
				,{field:'rule',title:'请求路由',align:'center',templet:function(d){
				...
				,{field:'status_code',title:'返回状态码',align:'center',templet:function(d){
                        return layui.laytpl('{{=d.status_code}}').render({status_code:d.status_code});
                    }}
