...
class CurdCategory extends Command
{
    ...
    protected function set_controller_param(){
        ...
        $data['parent_field'] = isset($this->curd_config['global']['parent_field']) ? $this->curd_config['global']['parent_field'] : 'pid';
        $data['name_field'] = isset($this->curd_config['global']['name_field']) ? $this->curd_config['global']['name_field'] : 'name';
