...
use addons\autocreate\admin\command\Api\library\Builder;
use addons\autocreate\admin\command\Api\library\Extractor;
    ...
    protected function execute(Input $input, Output $output)
    {
        ...
        foreach ($files as $name => $file) {
            if (!$file->isDir()) {
                ...
                $className = $this->get_class_from_file($filePath);
                ...
                $weighs[$this->get_class_from_file($filePath)] = $weigh;
                $k++;
            }
        }
