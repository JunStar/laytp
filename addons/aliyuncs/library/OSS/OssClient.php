<?php
namespace addons\aliyuncs\library\OSS;

use addons\aliyuncs\library\OSS\Core\MimeTypes;
use addons\aliyuncs\library\OSS\Core\OssException;
use addons\aliyuncs\library\OSS\Http\RequestCore;
use addons\aliyuncs\library\OSS\Http\RequestCore_Exception;
...
use addons\aliyuncs\library\OSS\Model\LiveChannelConfig;
use addons\aliyuncs\library\OSS\Model\LiveChannelInfo;
use addons\aliyuncs\library\OSS\Model\LiveChannelListInfo;
use addons\aliyuncs\library\OSS\Model\StorageCapacityConfig;
use addons\aliyuncs\library\OSS\Result\AclResult;
use addons\aliyuncs\library\OSS\Result\BodyResult;
use addons\aliyuncs\library\OSS\Result\GetCorsResult;
use addons\aliyuncs\library\OSS\Result\GetLifecycleResult;
use addons\aliyuncs\library\OSS\Result\GetLocationResult;
use addons\aliyuncs\library\OSS\Result\GetLoggingResult;
use addons\aliyuncs\library\OSS\Result\GetRefererResult;
use addons\aliyuncs\library\OSS\Result\GetStorageCapacityResult;
use addons\aliyuncs\library\OSS\Result\GetWebsiteResult;
use addons\aliyuncs\library\OSS\Result\GetCnameResult;
use addons\aliyuncs\library\OSS\Result\HeaderResult;
use addons\aliyuncs\library\OSS\Result\InitiateMultipartUploadResult;
use addons\aliyuncs\library\OSS\Result\ListBucketsResult;
use addons\aliyuncs\library\OSS\Result\ListMultipartUploadResult;
use addons\aliyuncs\library\OSS\Model\ListMultipartUploadInfo;
use addons\aliyuncs\library\OSS\Result\ListObjectsResult;
use addons\aliyuncs\library\OSS\Result\ListPartsResult;
use addons\aliyuncs\library\OSS\Result\PutSetDeleteResult;
use addons\aliyuncs\library\OSS\Result\DeleteObjectsResult;
use addons\aliyuncs\library\OSS\Result\CopyObjectResult;
use addons\aliyuncs\library\OSS\Result\CallbackResult;
use addons\aliyuncs\library\OSS\Result\ExistResult;
use addons\aliyuncs\library\OSS\Result\PutLiveChannelResult;
use addons\aliyuncs\library\OSS\Result\GetLiveChannelHistoryResult;
use addons\aliyuncs\library\OSS\Result\GetLiveChannelInfoResult;
use addons\aliyuncs\library\OSS\Result\GetLiveChannelStatusResult;
use addons\aliyuncs\library\OSS\Result\ListLiveChannelResult;
use addons\aliyuncs\library\OSS\Result\AppendResult;
use addons\aliyuncs\library\OSS\Model\ObjectListInfo;
use addons\aliyuncs\library\OSS\Result\SymlinkResult;
use addons\aliyuncs\library\OSS\Result\UploadPartResult;
use addons\aliyuncs\library\OSS\Model\BucketListInfo;
use addons\aliyuncs\library\OSS\Model\LifecycleConfig;
use addons\aliyuncs\library\OSS\Model\RefererConfig;
use addons\aliyuncs\library\OSS\Model\WebsiteConfig;
